        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-card-foreground">ChemFlow Solutions</span>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="text-muted-foreground">info@chemflowsolutions.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-2">
        ...
        <div className="border-t border-card-border mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">
              © 2024 ChemFlow Solutions. All rights reserved.
            </p>
